...
def from_cam(sess):
    ...
    face_cascade = cv2.CascadeClassifier('/Applications/Enthought/Canopy_64bit/User/share/OpenCV/haarcascades/haarcascade_frontalface_default.xml')
...
if __name__ == '__main__':
    ...
    emoji_png_files_path = os.path.join(EMOJI_FILE_PATH, '*.jpg')
